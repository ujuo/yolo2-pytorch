...
class VOCDataset(ImageDataset):
    def __init__(self, imdb_name, datadir, batch_size, im_processor,
        ...
        self._devkit_path = os.path.join(datadir,'xml_format_yolo')
        self._data_path = self._devkit_path # os.path.join(self._devkit_path,)
    ...
    def image_path_from_index(self, index):
        ...
        """
        image_path = os.path.join(self._data_path, 'images','0',
    ...
    def _load_image_set_index(self):
        ...
        image_set_file = os.path.join(self._data_path, 'imagesets','0'
                                      ,self._image_set + '.txt')
    ...
    def _annotation_from_index(self, index):
        ...
        format.
        """
        filename = os.path.join(self._data_path, 'xml','0', index + '.xml')
